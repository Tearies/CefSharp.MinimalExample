...
namespace CefSharp.MinimalExample.Common.args
{
    public static  class TypeExtension
    {
        ...
        public static T FindFirst<T>(this ICollection<T> @this, Predicate<T> predicate) where T : class
        {
            if (@this.IsInvalid())
                return null;
        ...
        /// 元素在集合中上移
        /// </summary>
        public static void MoveUp<T>(this IList<T> @this, T item)
        {
            if (@this == null || item == null || @this.Count <= 1)
                return;
        ...
        /// 元素在集合中下移
        /// </summary>
        public static void MoveDown<T>(this IList<T> @this, T item)
        {
            if (@this == null || item == null || @this.Count <= 1)
                return;
            var index = @this.IndexOf(item);
